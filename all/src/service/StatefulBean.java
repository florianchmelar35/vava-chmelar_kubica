...
//
///**
// * Hlavna Stateful beana, ktora si pamata prihlaseneho uzivatela
// */
//
//@Stateful
...
//
//    @Override
//    public int checkUser(User user2) {
//
//        Connection c = null;
//        Statement stmt;
//        ResultSet rs;
...
//
//            String querry = String.format("SELECT * FROM organizeit.user WHERE name = '%s'", user2.getLogin());
...
//            if(!rs.next())
//                return -1;
//            if (!rs.getString(3).equals(user2.getPassword()))
//                return -2;
//
//            user = new User(user.getLogin(), user.getPassword());
...
//
//    @Override
//    public boolean signUpUser(User user2) {
//        Connection c = null;
//        Statement stmt;
...
//            stmt = c.createStatement();
//
//            String querry = String.format("SELECT count(*) FROM organizeit.user WHERE name ='%s'", user2.getLogin());
//            rs = stmt.executeQuery(querry);
//            rs.next();
//            if(rs.getInt(1) > 0)
//                return false;
...
//            pStmt.setString(1, user2.getLogin());
//            pStmt.setString(2, user2.getPassword());
//            pStmt.execute();
//
//
////            vyhladanie priradeneho id
//            querry = String.format("SELECT * FROM organizeit.user WHERE name = '%s'", user2.getLogin());
//            rs = stmt.executeQuery(querry);
//            rs.next();
...
//
//    @Override
//    public List<Group> refresh(List<Group> list, List<Integer> deleted, List<Integer> created) {
//        logout(list, deleted, created);
//        return getData();
//    }
//
//    @Override
//    public boolean logout(List<Group> list, List<Integer> deleted, List<Integer> created) {
//        if (user == null)
//            return false;
//
//        Connection c = null;
...
//
//    @Override
//    public Group addGroup(int idGroup){
//        if (user == null)
//            return null;
//
//        int idUser = user.getId();
